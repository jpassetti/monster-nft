...
function mostSaturatedColor(colors) {
...
function colorMixer(hex1, hex2, percent) {
...
function sortColors(colors, type) {
...
function mixSortColors(colors, type, mixcolor, percentage) {
		const input = colors.slice(0)
		const output = []
